...
>(({ text = "Login", className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      className={cn(
        "group relative w-28 cursor-pointer overflow-hidden rounded-full border bg-background p-2 text-center font-semibold",
        className,
      )}
      {...props}
    >
